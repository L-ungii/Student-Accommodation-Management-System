    ...
    <div class="theme-container">
        ...
        <div class="confirmation-details">
            <%
                ...
                Integer studentNum = stud.getStudNum();
                String studentName = stud.getName();
                String studentSurname = stud.getSurname();
            %>
            <div class="detail-item"><strong>Student Number:</strong> <span><%= studentNum != null ? studentNum : "N/A" %></span></div>
            <div class="detail-item"><strong>Name:</strong> <span><%= studentName != null ? studentName : "N/A" %></span></div>
            <div class="detail-item"><strong>Surname:</strong> <span><%= studentSurname != null ? studentSurname : "N/A" %></span></div>
        </div>

        <div class="button-group">
            <form action="CancelRegitrationServlet.do" method="POST">
                <input type="hidden" name="appId" value="<%= appId != null?appId : "0" %>" />
                <button type="submit" class="confirm-button">Confirm Cancellation</button>
            </form>
            <form action="ViewApplicationStudent.do" method="GET">
