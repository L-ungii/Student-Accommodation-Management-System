...
public class Reservation implements Serializable {
    ...
    public Reservation(Date reservation_year, List<Residence> residence, List<Room> room, List<Student> student) {
    ...
    public Date getReservation_year() {
        return reservation_year;
    }

    public void setReservation_year(Date reservation_year) {
        this.reservation_year = reservation_year;
    }
