...
public class Application implements Serializable {
    ...
    public Application(String status, String roomType, Date startDate, Date endDate, Byte[] proofOfFunding, Byte[] proofOfReg, List<Student> student, List<Residence> residence) {
        this.status = status;
